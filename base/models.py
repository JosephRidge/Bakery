...
class Author(models.Model):
    user = models.OneToOneField(User, on_delete=models.CASCADE) # links with only one user
...
class Post(models.Model):
    author = models.ForeignKey(Author, on_delete=models.CASCADE) # cascade => when user is deleted it deletes everything related to it.
    ...
    def __str__(self):
        return f"Post by {author.user.username}"
...
class Comment(models.Model):
    ...
    def __str__(self):
        return f"by {author.user.username}"